...
//   rest/foto/?id_viaje={ID_VIAJE}  -> devuelve un array con todas las fotos del viaje cuyo id se le pasa
...
{   // Se utilizan parámetros
    ...
    { // se piden todas las fotos de una salida
    	$mysql = 'select * from foto where ID_VIAJE=' . sanatize($PARAMS['id_viaje']);
    }
    else
    {
